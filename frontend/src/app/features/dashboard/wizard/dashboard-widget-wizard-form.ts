...
export const DASHBOARD_WIDGET_NAME_MAX_LENGTH = 200;
export const DASHBOARD_WIDGET_DESCRIPTION_MAX_LENGTH = 500;

export interface DashboardWidgetWizardFormControls {
...
export type DashboardWidgetWizardForm = FormGroup<DashboardWidgetWizardFormControls>;

export interface DashboardWidgetWizardFormValue {
  name: string;
  description: string;
  dateFrom: Date | null;
  dateTo: Date | null;
...
export function createDashboardWidgetWizardForm(): DashboardWidgetWizardForm {
  return new FormGroup<DashboardWidgetWizardFormControls>(
    {
      name: new FormControl('', {
        nonNullable: true,
        validators: [requiredTrimmed, Validators.maxLength(DASHBOARD_WIDGET_NAME_MAX_LENGTH)]
      }),
      description: new FormControl('', {
        nonNullable: true,
        validators: [Validators.maxLength(DASHBOARD_WIDGET_DESCRIPTION_MAX_LENGTH)]
      }),
